...
INPUT_FILE = os.path.join(RESULTS_DIR, "licensed_repos.jsonl")
OUTPUT_FILE = os.path.join(RESULTS_DIR, "filtered_no_forks.jsonl")
LOG_FILE = os.path.join(LOGS_DIR, "filter_forked_projects_log.log")
...
logging.info(f"Total: {total}, Filtered forks: {filtered}, Written: {written}")
